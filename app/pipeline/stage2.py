...
class Stage2Pipeline:
    ...
    def _render_selected_topic_locked(self, channel: Channel, topic: dict[str, str]) -> None:
        ...
        scenes = self.media.generate_scene_assets(topic["topic_id"], scenes, source_mode=self.settings.media_source_mode)
        ...
        video_path, video_url = self.media.render_video(manifest)
